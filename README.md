...
_G.K = {A = false, F = 150, SF = false, AF = false, EB = false, ES = false, EH = false, EN = false, EI = false, EU = false, EY = false, HT = false, NC = false, S = 16, J = 50, BH = false, WB = false, FLY = false, TIdx = 1, LastFire = 0, HB = false, INF = false, TARG = false, TPB = false, X = false, RP = false, SP = false, ANTIHIT = false}
...
local LangPack = {
    TR = {
        ...
        S150 = "HIZ: 150", J150 = "ZIPLAMA: 150", FLY = "FLY (UCMA)", BH = "BUNNYHOP", WB = "WALLBANG", NC = "NOCLIP", HB = "GIZLI HITBOX", INF = "SONSUZ MERMI", RP = "SERI ATES (RAPID)", ColorTitle = "RENKLER 🎨", ANTIHIT = "🛡️ ANTI-HIT (DODGE)"
    },
    EN = {
        ...
        X = "OLD SCHOOL ANIM", SP = "SPINBOT",
        S150 = "SPEED: 150", J150 = "JUMP: 150", FLY = "FLY", BH = "BUNNYHOP", WB = "WALLBANG", NC = "NOCLIP", HB = "SILENT HITBOX", INF = "INFINITE AMMO", RP = "RAPID FIRE", ColorTitle = "COLORS 🎨", ANTIHIT = "🛡️ ANTI-HIT (DODGE)"
    }
}
...
local bANTI = Add(xT, "ANTIHIT", "ANTIHIT", 363) -- NEW GHOST REPLICATION
...
RS.RenderStepped:Connect(function()
    ...
    if h and hrp then
        ...
        -- [[ CORE ENGINE: ANTI-HIT (SERVER DESYNC) ]]
        if _G.K.ANTIHIT then
            -- Pozisyon verisini her karede sunucunun kafasını karıştıracak şekilde senkronize dışı bırakır.
            local originalVelocity = hrp.Velocity
            hrp.Velocity = originalVelocity + Vector3.new(0, 45, 0)
            RS.Heartbeat:Wait()
